...
class SettingsService {
  ...
  static const String _keySideChange = 'side_change_alert_enabled';
  static const String _keyVoice = 'voice_enabled';
  ...
  Future<bool> isSideChangeAlertEnabled() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getBool(_keySideChange) ?? true;
  }
  ...
  Future<String> getInputMode() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_keyInputMode) ?? 'two_buttons';
  }
  ...
  Future<void> setSideChangeAlertEnabled(bool enabled) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool(_keySideChange, enabled);
  }

  Future<void> setVoiceEnabled(bool enabled) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool(_keyVoice, enabled);
  }
